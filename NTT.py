...
elem_id.send_keys('jisco0005')
elem_pw = browser.find_element_by_id('pwdLoginPsw')
elem_pw.send_keys('Jisco1112')
...
for file1 in glob.glob('D:/user/Downloads/*.pdf'):
  print(file1)
file2 = 'D:/user/Downloads/NTT西日本(00-7859-4347).pdf'
os.rename(file1, file2)
import tabula
pdf_path = 'D:/user/Downloads/NTT西日本(00-7859-4347).pdf'
