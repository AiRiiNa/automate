...
elem_id.send_keys('12345')

elem_pw = browser.find_element_by_id('pwdLoginPsw')
elem_pw.send_keys('abcde')
...
file2 = 'D:/user/Downloads/NTT(01-2345-6789).pdf'

os.rename(file1, file2)

import tabula

pdf_path = 'D:/user/Downloads/NTT(01-2345-6789).pdf'
...
x = siharaibi + 'NTT(01-2345-6789)' + kingaku + '円.pdf'
